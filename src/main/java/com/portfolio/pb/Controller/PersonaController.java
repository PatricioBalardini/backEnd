...
public class PersonaController {
    ...
    public ResponseEntity<List<Persona>> lista () {
        List<Persona> list = personaService.lista();
    ...
    @PostMapping("/crear")
    public ResponseEntity<?> crear (@RequestBody dtoPersona dtopersona) {
    ...
    public ResponseEntity<?> actualizar (@PathVariable("id") int id, @RequestBody dtoPersona dtopersona) {
        if(!personaService.existsById(id)) {
            return new ResponseEntity(new Mensaje("No existe el ID"), HttpStatus.NOT_FOUND);
        }
